...
def main():
    ...
    # group by species_code and display in alphabetical order
    ...
    # create dictionary of select species_code and common names
    b_dict = {
    ...
    input('\n') 
    print('\n>  Find observed locations for up to three species.\n')
    ...
    while count < 3:
        ...
        for x in b_dict:
            if x == n:
                ...
                print('.\n')
                result_df = bird_df[bird_df['sp_code'].str.contains(n)]
    ...
    print('\n>  Find unique observation identifier for up to two species.\n')
    print('------------------------------------------------------------------')
